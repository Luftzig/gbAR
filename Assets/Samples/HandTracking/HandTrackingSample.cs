...
public class HandTrackingSample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spawnedObject = Instantiate(cube, worldJoints[9], Quaternion.identity);
    }
    ...
    void Update()
    {
        ...
        if (spawnedObject==null) spawnedObject = Instantiate(cube, worldJoints[9], Quaternion.identity);
        else spawnedObject.transform.position = worldJoints[9];
